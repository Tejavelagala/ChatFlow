...
Generated by 'django-admin startproject' using Django 5.2.14.from dotenv import load_dotenv
...
MIDDLEWARE = [
    ...
    'chats.ratelimit.RateLimitMiddleware',
]
...
if not DB_ENGINE:
    # choose based on whether a DATABASE_URL is provided; default to sqlite for local dev
